...
async function initializeDatabase() {
  try {
    ...
    console.log(
      '1. stocks - with columns: id, name, ticker, shares, buy_price, current_price, target_price, is_in_watchlist, last_updated'
    );
    console.log(
      '2. watchlists - with columns: id, name, ticker, target_price, current_price, last_updated, created_at, updated_at'
    );
  } catch (error) {
